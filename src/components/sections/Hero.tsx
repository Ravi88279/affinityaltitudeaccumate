...
const Hero = () => {
  return (
    <section className="relative pt-20 overflow-hidden">
      ...
      <div className="container-tight min-h-[85vh] flex flex-col justify-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden leading-none">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full h-auto animate-wave-slow relative z-10">
